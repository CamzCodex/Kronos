...
| Web UI security adversarial review | Challenges local-file, browser-origin, input-integrity, resource, error, launcher, checkpoint, and remote-deployment boundaries | 2026-07-22 | No research dataset | Unpinned interactive IDs; not benchmark evidence | Introduced by `security/webui-local-boundary` | High for covered loopback controls; no remote-security claim | None | Current | `docs/reviews/ADVERSARIAL_REVIEW_WEBUI_SECURITY.md` |
